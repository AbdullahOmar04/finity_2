  ...
  Future<void> _createBillSplit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Error creating bill split: $e')));
    }
  }
...
class _EnhancedBillStatusDialog extends StatefulWidget {
  ...
  @override
  _EnhancedBillStatusDialogState createState() =>
      _EnhancedBillStatusDialogState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(
                      done ? Icons.check_circle : Icons.payment,
                      color: done ? cs.primary : cs.primary,
                      size: 24,
                    ),
                  ),
                  const SizedBox(width: 12),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _detailRow(
                      'Per Person:',
                      '${(perCents / 100).toStringAsFixed(2)} JD',
                      cs.onSurface,
                    ),
                    const SizedBox(height: 8),
                    _detailRow(
                      'Collected:',
                      '${collected.toStringAsFixed(2)} JD',
                      cs.primary,
                    ),
                    const SizedBox(height: 8),
                    _detailRow(
                      'Remaining:',
                      '${remaining.toStringAsFixed(2)} JD',
                      cs.error,
                    ),
                  ],
                ),
              ...
              if (lastDate != null) ...[
                ...
                Text(
                  'Last payment: ${_formatTime(lastDate)}',
                  style: Theme.of(
                    context,
